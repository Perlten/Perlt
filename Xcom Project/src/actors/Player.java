...
public class Player extends Actor {
    ...
    public Player(int x, int y, String texturePath, KeyInput keyInput, int movementSpeed, World world) {
        super(x, y, new Rectangle(32, 32), texturePath, movementSpeed, world);
