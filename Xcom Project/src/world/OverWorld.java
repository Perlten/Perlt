...
public abstract class OverWorld extends World {
    ...
    public OverWorld(MouseInput mouseInput, KeyInput keyInput, String worldName, State state, boolean battleWorld) {
